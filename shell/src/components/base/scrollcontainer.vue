...
<template>
  ...
  >
    ...
    <Dragable
      v-if="(type == 'both' || type == 'vertical') && (!verticalProp.isHide) && isShowScrollbar"
      :axis="verticalProp.axis"
      :clip-rect="verticalProp.clipRect"
      :top="veritcalPos"
      :left="verticalProp.left"
      :width="verticalProp.width"
      :height="verticalProp.height"
      :imm="true"
      class-name="pt-scroll-bar"
      cursor="default"
      @move-to="handleBarTrack($event, 'vertical')"
      @drag-start="handleStartBarTrack"
      @drag-end="handleEndBarTrack"
    />
    <Dragable
      v-if="(type == 'both' || type == 'horizontal') && (!horizontalProp.isHide) && isShowScrollbar"
      :axis="horizontalProp.axis"
      :clip-rect="horizontalProp.clipRect"
      ...
      class-name="pt-scroll-bar"
      cursor="default"
      @move-to="handleBarTrack($event, 'horizontal')"
      @drag-start="handleStartBarTrack"
      @drag-end="handleEndBarTrack"
    />
  </div>
