...
<template>
  <div class="n-terminal-preview" v-bind="$attrs">
    ...
    <div class="theme-color" :style="themeStyle">
      ...
      <div class="theme-color-item">
        <span>drwxr-xr-x 3 root&nbsp;</span>
        <span :style="{ color: currentTheme.green }">NxShell</span>
      </div>
      <div class="theme-color-item">
        <span>drwxr-xr-x 3 root&nbsp;</span>
        <span
          ...
          :style="{
            ...
            '--data-before': currentTheme.cyan,
            '--data-after': currentTheme.red,
          }"
        >-></span>
      </div>
      <div class="theme-color-item">
  ...
  .theme-color {
    ...
    &-item {
      ...
      .n-link {
        &::before {
          content: 'sym ';
          color: var(--data-before);
        }

        &::after {
          content: ' link';
          color: var(--data-after);
        }
      }
    }
  }
