<template>
	...
	>
		...
		<el-table :data="keys" style="width: 100%" v-loading="loading" empty-text="" max-height="360">
		...
		>
			<el-form label-position="top" @submit.prevent>
				...
				<el-form-item :label="t('home.settings.ssh-keys.passphrase')">
					<el-input v-model="genForm.passphrase" type="password" show-password
						:placeholder="t('home.settings.ssh-keys.passphrase-placeholder')" />
				</el-form-item>
			</el-form>
			<template #footer>
				<el-button @click="showGenerateDialog = false">{{ t('components.Cancel') }}</el-button>
