...
import { buildSystemPrompt, chat } from '@/services/ai/provider'
...
<template>
  <div v-show="visible" class="ai-assistant-panel" :style="{ width: `${panelWidth}px` }">
    <div class="ai-assistant-resizer" @mousedown="startResize" />
    ...
    <div ref="messagesContainer" class="ai-assistant-messages">
      <div
        ...
        :class="[`ai-assistant-message--${msg.role}`]"
      >
    ...
    <div v-if="suggestedCommand" class="ai-assistant-command">
      <div class="ai-assistant-command__header">
        <span class="ai-risk-badge" :class="[`ai-risk-badge--${risk.level}`]">
