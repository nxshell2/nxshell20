<template>
	<SessionFormLayout
		ref="formLayoutRef"
		protocol="LocalShell"
		:rules="localShellFormRules"
		:default-form="defaultForm"
		:description="t('components.session.protocol-names.LocalShell') + ' session'"
		:form-data="formData"
		@save="handleSave"
	...
	>
		<template #base>
			<el-form-item :label="$t('home.profile.base.shell-type.title')" prop="shellType">
				<el-select v-model="formData.shellType" style="width: 100%">
					<el-option :label="t('home.profile.base.shell-type.options.powershell')" value="powershell" />
					<el-option :label="t('home.profile.base.shell-type.options.cmd')" value="cmd" />
					<el-option :label="t('home.profile.base.shell-type.options.bash')" value="bash" />
					<el-option :label="t('home.profile.base.shell-type.options.zsh')" value="zsh" />
				</el-select>
			</el-form-item>
		</template>
	</SessionFormLayout>
