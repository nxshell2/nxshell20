  ...
  methods: {
    installHandlers() {
      ...
      this.mouseMoveHandler = (evt) => {
        ...
        const axis = this.axis.toLowerCase()
        const axisX = axis == 'x' || axis == 'both'
        const axisY = axis == 'y' || axis == 'both'

        const mouseout = {}
        const _isMouseOut = false
        const offsetX = evt.clientX - this.parentPosistion.left
        const offsetY = evt.clientY - this.parentPosistion.top
