<template xmlns=''>
	<div class='pt-file-view'>
		<pt-toolbar :centerStyle="{ overflow: 'hidden', marginLeft: '10px', marginRight: '10px' }">
			...
			<template #center><pt-file-view-address
		...
		/>
		<!-- 查看文件属性弹窗 -->
		<el-dialog :title="$t('home.fileview.prop-dialog.file-props')" width='40%' v-model='filePropDialog.show'>
