						...
						<el-row :gutter="10">
							...
							<el-col :span="12">
								...
								<el-form-item :label="$t('home.profile.base.port.title')" prop="hostTelnetPort">
									<el-input-number v-model="sessionForm.hostTelnetPort" :min="1" :max="65535" controls-position="right"/>
								</el-form-item>
							</el-col>
						</el-row>
					</el-tab-pane>
					...
					<el-tab-pane :label="t('components.session.theme.label')" name="theme">
						<div class="n-theme-form">
							...
							<div class="item theme">
								<xtermThemeList v-model:value="sessionForm.xtermTheme" :theme-options="sessionForm" />
							</div>
						</div>
					</el-tab-pane>
				</el-tabs>
